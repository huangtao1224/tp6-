var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var body = document.getElementById("particles");
		...
		canvas.element.style = "position: fixed; top: 0; left: 0; z-index: 0;";
	...
	function canvasSize(canvas){
		...
		// 获取特定div的宽高
		var width = document.getElementById("particles").style.width;
		var height = document.getElementById("particles").style.height;
